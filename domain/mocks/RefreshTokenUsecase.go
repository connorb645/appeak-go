...
func (_m *RefreshTokenUsecase) ExtractIDFromToken(requestToken string, secret string) (*primitive.ObjectID, error) {
	ret := _m.Called(requestToken, secret)

	var r0 *primitive.ObjectID
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string) (*primitive.ObjectID, error)); ok {
...
func (_m *RefreshTokenUsecase) GetUserByID(c context.Context, id primitive.ObjectID) (domain.User, error) {
	ret := _m.Called(c, id)
