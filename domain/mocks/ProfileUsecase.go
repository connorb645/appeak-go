...
func (_m *ProfileUsecase) GetProfileByID(c context.Context, userID primitive.ObjectID) (*domain.Profile, error) {
	ret := _m.Called(c, userID)

	var r0 *domain.Profile
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, primitive.ObjectID) (*domain.Profile, error)); ok {
		return rf(c, userID)
	}
